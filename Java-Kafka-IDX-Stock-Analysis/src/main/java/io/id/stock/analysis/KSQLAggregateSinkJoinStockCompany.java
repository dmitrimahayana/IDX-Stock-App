...
public class KSQLAggregateSinkJoinStockCompany extends Thread {
    private static final Logger log = LoggerFactory.getLogger(KSQLAggregateSinkJoinStockCompany.class.getSimpleName());
    ...
    public void run() {
        ...
        String pushQueryStock = "SELECT * FROM KSQLTABLEJOINSTOCKCOMPANY EMIT CHANGES;";
        ...
        try {
            ...
            while (true) {
                ...
                if (rowStock != null) {
                    ...
                    log.info(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").format(new Date()) + " Sync Query Join Stock Result " + finalJson);
                }
            }
