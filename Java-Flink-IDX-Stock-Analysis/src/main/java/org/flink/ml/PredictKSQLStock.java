...
public class PredictKSQLStock {
    public static void main(String[] args) throws Exception {
        ...
        RemoteServer remoteServer = new RemoteServer(Boolean.TRUE, jarsPath);
...
//        Table inputTable = tableEnv.sqlQuery("SELECT * FROM flink_ksql_groupstock WHERE `DATE` LIKE '%2023-08%' LIMIT 5");
...
//            Row row = it.next();
//            System.out.println("Ticker: " + row.getField("TICKER") + " --- Date: " + row.getField("DATE") + " --- Close: " + row.getField("CLOSE"));
//        }
...
//            System.out.printf("Scaled Input Value: %s\tLabel Value: %s\n", features, label);
//        }
